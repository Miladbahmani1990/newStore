    ...
    <>
      ...
      <div className="row" style={{ height: "auto" }}>
        <div className="col-12 col-sm-6">
          <img src="/image/pic-home/whats-hot-blog-home-e.jpg" alt="" className="img-fluid"/>
        </div>
        <div className="col-12 col-sm-6">
          <h1 className=" mt-5 ">
          ...
          <h2 className="w-75 mt-5 ">
            ...
            book. I love to read and travel and over time What’s Hot? has become
            a hub for fellow literary travellers.
          </h2>
          <h2 className="w-75 mt-5">
        ...
        <div className="row mt-5">
          <div className="col-12 col-sm-4">
            <img src="/image/pic-home/Books-Like-The-Seven.jpg.webp" alt="" className="img-fluid" />
          </div>
          <div className="col-12 col-sm-8">
            ...
            <p className="fs-2">
              ...
              these 6 books like The Seven Husbands of Evelyn Hugo! The Seven
              Husbands of Evelyn Hugo is an absorbing read. It follows
              journalist Monique Grant as she interviews the glamorous and
              reclusive former movie star, Evelyn
            </p>
            <p className="fs-2">
            Hugo. It’s an addictive story, with…
            </p>
            <strong ><a href="/" className="Reading fs-2 text-dark">Continue Reading</a></strong>
          </div>
